...
class Controller extends BaseController
{
    ...
    public static function all_content(int $i)
    {
        ...
        $allContent['sponsors'] = Controller::all_sponsors();
        return $allContent;
    }

    public static function all_sponsors()
    {

        $sponsors = Sponsors::select('sponsors.id','pictures.alt','sponsors.link','sponsors.size','sponsors.name as sname','sponsors.updated_at','pictures.name', 'pictures.directory')->join('pictures', 'pictures.id', '=', 'sponsors.picture_id')
            ->orderBy('size')->get();
