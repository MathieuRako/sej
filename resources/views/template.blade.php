...
<body>
        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">
                    ...
                    <span class="align-self-center" id="title"> JUDO CLUB SAMURAI EINDHOUT</span>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav " id="navigation">
                        <a class="nav-item nav-link {{ Route::currentRouteNamed('home') ? 'active' : '' }}" href="/">HOME</a>
                        <div class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle {{ Route::currentRouteNamed('club') ? 'active' : '' }}" href="club" id="navbarDropdown" role="button" aria-haspopup="true"
                                aria-expanded="false">
                                CLUB
                            </a>
                        ...
                        <a class="nav-item nav-link {{ Route::currentRouteNamed('judo') ? 'active' : '' }}" href="judo">JUDO</a>
                        <a class="nav-item nav-link {{ Route::currentRouteNamed('belts') ? 'active' : '' }}" href="belts">BELTS/GRADEN</a>
                        <div class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle {{ Route::currentRouteNamed('informations') ? 'active' : '' }}" href="informations" id="navbarDropdown" role="button"
                        ...
                        <a class="nav-item nav-link {{ Route::currentRouteNamed('sponsors') ? 'active' : '' }}" href="sponsors">SPONSORS</a>
    ...
    <footer class="bg-dark text-center text-white">
            ...
            <section class="">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 mb-4 mb-md-0">
                        ...
                        <p>Judo Club Samurai Eindhout</p>
                    </div>
                    <!--Grid column-->
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                        ...
                        <p><img src="images/house.svg" alt="telephone"></img> New York, NY 10012, US</p>
                        <p><img src="images/envelope.svg" alt="telephone"></img> info@example.com</p>
                        <p><img src="images/telephone.svg" alt="telephone"></img> + 01 234 567 88</p>
                        <p href="google.com"><img src="images/facebook.svg" alt="telephone"></img> Facebook </p>
                    </div>
                    <!-- Grid column -->
                </div>
                <!--Grid row-->
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
            <p> Auteursrecht © 2022 Template 7 – Privacybeleid – Cookie instellingen</p>
        </div>
        <!-- Copyright -->
    </footer>
</body>
